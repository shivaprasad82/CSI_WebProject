			...
			<div class="row">
				<div class="col-lg-4 price-mobamus">
					...
					<div class="price-w3ls-bottom p-4">
						<h4 class="my-2"><a href="/single">Old Goa Residency</a></h4>
						
						<div class="lm-item-price">
							<h6>
								<span class="price-top-head">RS</span>
								<span class="price-midd-head">18,800</span>
						...
						<a href="/book?param1=Old Goa Residency&param2=18,800" class="btn button-style-2 mt-sm-5 mt-4">Book Now</a>
					</div>
				</div>
				<div class="col-lg-4 price-mobamus my-lg-0 my-5">
					<div class="price-top">
						<a href="">
							<img src="https://q-cf.bstatic.com/images/hotel/max1024x768/202/202983040.jpg" alt="" class="img-fluid" />
						</a>
					</div>
					<div class="price-w3ls-bottom p-4">
						<h4 class="my-2"><a href="/single">Grand Hyatt Goa</a></h4>
						...
						<a href="/book?param1=Grand Hyatt Goa&param2=16,500" class="btn button-style-2 mt-sm-5 mt-4">Book Now</a>
					</div>
				</div>
				<div class="col-lg-4 price-mobamus">
					<div class="price-top">
						<a href="">
							<img src="https://media-cdn.tripadvisor.com/media/photo-s/13/f1/1b/68/hotel-hill-rock.jpg" alt="" class="img-fluid" />
						</a>
					</div>
					<div class="price-w3ls-bottom p-4">
						...
						<div class="lm-item-price">
							<h6>
								<span class="price-top-head">RS</span>
								<span class="price-midd-head">16,000</span>
								<span class="price-right-head">/ per day</span>
							</h6>
						</div>
						<ul class="style-lists">
						...
						<a href="/book?param1=Trident&param2=16,000" class="btn button-style-2 mt-sm-5 mt-4">Book Now</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid py-xl-5 py-lg-3">
			...
			<div class="row">
				<div class="col-lg-4 price-mobamus">
					<div class="price-top">
						<a href="">
							<img src="https://imgcld.yatra.com/ytimages/image/upload/t_seo_Hotel_w_437_h_230_c_fill_g_auto_q_auto:good_f_auto/v1560246768/Hotel/00003951/123_RCGnCI.jpg" alt="" class="img-fluid" />
						</a>
					</div>
					<div class="price-w3ls-bottom p-4">
						<h4 class="my-2"><a href="/single">La Grande Residencia</a></h4>
						
						<div class="lm-item-price">
							<h6>
								<span class="price-top-head">RS</span>
								<span class="price-midd-head">15,600</span>
								<span class="price-right-head">/ per day</span>
							</h6>
						</div>
						<ul class="style-lists">
						...
						<a href="/book?param1=La Grande Residencia&param2=15,600" class="btn button-style-2 mt-sm-5 mt-4">Book Now</a>
					</div>
				</div>
				<div class="col-lg-4 price-mobamus my-lg-0 my-5">
					<div class="price-top">
						<a href="">
							<img src="https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2016/08/DoubleTree-by-Hilton-Hotel-Goa.jpg" alt="" class="img-fluid" />
						</a>
					</div>
					<div class="price-w3ls-bottom p-4">
						<h4 class="my-2"><a href="/single">Hotel Travellers Inn</a></h4>
						
						<div class="lm-item-price">
							<h6>
								<span class="price-top-head">RS</span>
								<span class="price-midd-head">15,300</span>
								<span class="price-right-head">/ per day</span>
							</h6>
						</div>
						<ul class="style-lists">
						...
						<a href="/book?param1=Hotel Travellers Inn&param2=15,300" class="btn button-style-2 mt-sm-5 mt-4">Book Now</a>
					</div>
				</div>
				<div class="col-lg-4 price-mobamus">
					<div class="price-top">
						<a href="">
							<img src="https://assets.traveltriangle.com/blog/wp-content/uploads/2016/08/Hard-rock-hotel-in-Goa.jpg" alt="" class="img-fluid" />
						</a>
					</div>
					<div class="price-w3ls-bottom p-4">
						<h4 class="my-2"><a href="/single">Mercure Goa Devaaya Retreat</a></h4>
						...
						<ul class="style-lists">
							<li>Only 5 rooms available</li>
							<li>Lunch included</li>
							<li>Free Wifi available</li>
						</ul>
						<a href="/book?param1=Mercure Goa Devaaya Retreat&param2=14,500" class="btn button-style-2 mt-sm-5 mt-4">Book Now</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid py-xl-5 py-lg-3">
			...
			<div class="row">
				<div class="col-lg-4 price-mobamus">
					<div class="price-top">
						<a href="">
							<img src="https://media-cdn.tripadvisor.com/media/photo-s/12/20/3a/57/pool-side-couple-rooms.jpg" alt="" class="img-fluid" />
						</a>
					</div>
					<div class="price-w3ls-bottom p-4">
						<h4 class="my-2"><a href="/single">Double Tree by Hilton Goa</a></h4>
						...
						<a href="/book?param1=Double Tree by Hilton Goa&param2=13,800" class="btn button-style-2 mt-sm-5 mt-4">Book Now</a>
					</div>
				</div>
				<div class="col-lg-4 price-mobamus my-lg-0 my-5">
					<div class="price-top">
					...
					<div class="price-w3ls-bottom p-4">
						<h4 class="my-2"><a href="/single">River Heights</a></h4>
						...
						<a href="/book?param1=River Heights&param2=13,000" class="btn button-style-2 mt-sm-5 mt-4">Book Now</a>
					</div>
				</div>
				<div class="col-lg-4 price-mobamus">
					<div class="price-top">
						<a href="">
							<img src="https://ihg.scene7.com/is/image/ihg/holiday-inn-resort-goa-6145673227-4x3" alt="" class="img-fluid" />
						</a>
					</div>
					<div class="price-w3ls-bottom p-4">
						<h4 class="my-2"><a href="/single">Case De Bambolim</a></h4>
						
						<div class="lm-item-price">
							<h6>
								<span class="price-top-head">RS</span>
								<span class="price-midd-head">12,500</span>
								<span class="price-right-head">/ per day</span>
							</h6>
						</div>
						<ul class="style-lists">
						...
						<a href="/book?param1=Case De Bambolim&param2=12,500" class="btn button-style-2 mt-sm-5 mt-4">Book Now</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid py-xl-5 py-lg-3">
			...
			<div class="row">
				<div class="col-lg-4 price-mobamus">
					<div class="price-top">
						<a href="">
							<img src="https://d2w5af8s1781.cloudfront.net/waytogo-staging/stylesheets/ct_hotels/images/Goa-hotels.jpg" alt="" class="img-fluid" />
						</a>
					</div>
					<div class="price-w3ls-bottom p-4">
						<h4 class="my-2"><a href="/single">The Fern Kadamba</a></h4>
				...
				<div class="col-lg-4 price-mobamus my-lg-0 my-5">
					...
					<div class="price-w3ls-bottom p-4">
						<h4 class="my-2"><a href="/single" name="hotel">Casa Chhabra</a></h4>
						...
						<a href="/book?param1=Casa Chhabra&param2=11,000" class="btn button-style-2 mt-sm-5 mt-4">Book Now</a>
					</div>
				</div>
				<div class="col-lg-4 price-mobamus">
					<div class="price-top">
					...
					<div class="price-w3ls-bottom p-4">
						<h4 class="my-2"><a href="/single"  id="W Wings">W Wings</a></h4>
						
						<div class="lm-item-price">
							<h6>
								<span class="price-top-head">RS</span>
								<span class="price-midd-head" id="9000">9,000</span>
								<span class="price-right-head">/ per day</span>
							</h6>
						</div>
						<ul class="style-lists">
						...
						<a href="" class="btn button-style-2 mt-sm-5 mt-4" onclick="setSession()">Book Now</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row package-grids">
				<div class="col-lg-4 posts-mobamus">
					...
					<div class="posts-w3ls-bottom py-4">
						<h4 class="mb-2"><a href="/single">Old Goa Residency</a></h4>
						<ul class="list-unstyled">
							<li>
								<a href="#">
									<span class="fa fa-thumbs-up mr-1"></span>984 Likes</a>
							</li>
							<li class="mx-3">
								<a href="#">
						...
						<p class="mt-3">"Excellent place,good services,nice stay,freindly staff."</p>
					</div>
				</div>
				<div class="col-lg-4 posts-mobamus my-lg-0 my-4">
					...
					<div class="posts-w3ls-bottom py-4">
						<h4 class="mb-2"><a href="/single">Grand Hyatt Goa</a></h4>
						<ul class="list-unstyled">
							<li>
								<a href="#">
									<span class="fa fa-thumbs-up mr-1"></span>886 Likes</a>
							</li>
							<li class="mx-3">
								<a href="#">
									<span class="fa fa-comments mr-1"></span>87 Comments</a>
							</li>
						</ul>
						<p class="mt-3"> Unscale rooms with private terraces,plus 3restaurants,indoor & outdoor pools, a spa & 2 bars.</p>
					</div>
				</div>
				<div class="col-lg-4 posts-mobamus">
					<div class="posts-top">
					...
					<div class="posts-w3ls-bottom py-4">
						<h4 class="mb-2"><a href="/single">Trident</a></h4>
						<ul class="list-unstyled">
							<li>
								<a href="#">
									<span class="fa fa-thumbs-up mr-1"></span>684 Likes</a>
							</li>
							<li class="mx-3">
								<a href="#">
									<span class="fa fa-comments mr-1"></span>68 Comments</a>
							</li>
						</ul>
						<p class="mt-3">Basic,air-conditioned rooms,some with balconies,pleasant living there. Staff is very attentive and professional. Rooms are nicely maintained and clean. Internet is fast.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row text-center">
				<div class="col-lg-4 col-md-6 team-gd-info">
					<div class="team-gd">
						<div class="team-img mb-4">
							<img src="https://th.thgim.com/entertainment/movies/article18598678.ece/alternates/FREE_435/29MPVivek01jpg" class="img-fluid" alt="user-image">
						</div>
						<div class="team-info">
							<h3>Vivek <span class="sub-tittle-team">India</span> </h3>
							...
							<p>The luxurious-ness and the detailing that has gone into building such a property & importantly keeping it awesomely clean is what makes Della stand apart ! </p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 team-gd-info mt-md-0 mt-5">
					<div class="team-gd">
						<div class="team-img mb-4">
							<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQ04A2ZQyIAS8Mu09Yc-jl89S37ckDlkKT3p7ruxZgN6vQpDAHQ&usqp=CAU" class="img-fluid" alt="user-image">
						</div>
						<div class="team-info">
							<h3>Sujatha Mohan<span class="sub-tittle-team">India</span></h3>
							<ul class="list-unstyled my-md-4 my-3">
								<li><span class="fa fa-star"></span></li>
								<li><span class="fa fa-star"></span></li>
								<li><span class="fa fa-star"></span></li>
							...
							<p>They help greatly to make the event pass peacefully and pleasant.I really love this place.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 mx-lg-0 mx-md-auto team-gd-info mt-lg-0 mt-5">
					<div class="team-gd">
						<div class="team-img mb-4">
							<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQ5cglmjnbecS-LtCNyr3cS2xROdkzesf86k5JGlvJ8okuGaSpS&usqp=CAU" class="img-fluid" alt="user-image">
						</div>
						<div class="team-info">
							<h3>AR Rehman<span class="sub-tittle-team">India</span></h3>
							<ul class="list-unstyled my-md-4 my-3">
								<li><span class="fa fa-star"></span></li>
								<li><span class="fa fa-star"></span></li>
								<li><span class="fa fa-star"></span></li>
							...
							<p>Hotel is clean as well as rooms and restaurant.Alought in the centre,it is very silent and pleasant.Service is perfect.Breakfast is good with large variety.</p>
						</div>
					</div>
				</div>
			</div>
